...
export class AssetController {
    ...
    static getAllAsset = async (req: Request, res: Response) => {
        try {
            ...
            if (req.user.role === "Administrador") {
                ...
                assets = await Asset.find({ user: req.user.id });
            }
    ...
    static getAssetById = async (req: Request, res: Response): Promise<void> => {
        const { id } = req.params
        try {
    ...
    static updateAsset = async (req: Request, res: Response): Promise<void> => {
        const { id } = req.params
        try {
            const asset = await Asset.findById(id)
